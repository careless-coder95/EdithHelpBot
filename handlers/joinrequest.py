...
JOINREQUEST_HELP_TEXT = (
    ...
    "╚════════════════════════╝\n\n"
    "<b>Commands:</b>\n\n"
    "• /acceptall on  — Auto accept ON ✅\n"
    "• /acceptall off — Auto accept OFF ❌\n\n"
    "<b>When OFF:</b>\n"
    "Bot sends a join request notification\n"
    "to the group with Approve / Decline\n"
    "buttons for admins.\n\n"
    "<b>Notes:</b>\n"
    "- Bot must be admin with approval rights.\n"
    "- Works only with join request links.\n"
    "- Only admins can approve or decline."
)
